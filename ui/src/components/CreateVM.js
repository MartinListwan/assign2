...
export class CreateVMComponent extends Component  {
    ...
    render() {
        return (
            <Card>
                <Select defaultValue={"Basic"} style={{ width: '40em', marginRight: '2em' }} onChange={(value) => this.setState({ vm_config: value })}>
                    <Option value={"Basic"}>8 virtual cores, 16 GB virtual memory, 20 GB storage, 5 cents/min</Option>
                    <Option value={"Large"}>32 virtual cores, 64 GB virtual memory, 20 GB storage, 10 cents/min</Option>
